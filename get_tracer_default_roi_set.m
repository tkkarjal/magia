...
switch lower(tracer)
    case {'[11c]carfentanil','[11c]pbr28'}
        roi_info.labels = {'amy' 'cau' 'dacc' 'ins' 'nacc' 'ofc' 'pcc' 'put' 'racc' 'tha'};
        roi_info.codes = {
            [18 54] % amy
            [11 50] % cau
            [1002 2002] % dacc
    ...
    case '[11c]madam'
        roi_info.labels = {'amy' 'cau' 'dacc' 'ins' 'medul' 'midbr' 'nacc' 'oc' 'ofc' 'pcc' 'pons' 'put' 'racc' 'tha'};
        roi_info.codes = {
            [18 54] % amy
            [11 50] % cau
            [1002 2002] % dacc
    ...
    case '[18f]fdg'
        roi_info.labels = {'amy' 'cau' 'dacc' 'ins' 'nacc' 'ofc' 'pcc' 'pcun' 'put' 'racc' 'tha'};
        roi_info.codes = {
            [18 54] % amy
            [11 50] % cau
            [1002 2002] % dacc
    ...
    case '[11c]flb'
        roi_info.labels = {'amy' 'cau' 'dacc' 'ins' 'nacc' 'oc' 'ofc' 'pcc' 'put' 'racc' 'tha'};
                roi_info.codes = {
            [18 54] % amy
            [11 50] % cau
            [1002 2002] % dacc
